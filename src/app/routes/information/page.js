...
export default function Page({}) {
  ...
  return (
    <>
      <main
        className={`${styles.main} ${styles.contentpage} ${localstyles.informPage}`}
      >
          ...
          data.data.map((item, index) => {
            return (
              <li>
                <a
                  download
                  href={`${process.env.NEXT_PUBLIC_CONNECT}://${process.env.NEXT_PUBLIC_URL_API}${item.attributes.doc.data.attributes.url}`}
                >
          ...
          data.data.map((item, index) => {
            return (
              <li>
                ...
                >
                  {`скачать`}
                  <span>( {item.attributes.doc.data.attributes.size} кб)</span>
                </a>
              </li>
            );
          })
