              ...
              : (data)
                  ...
                  <>
                    <div className = {`${styles.footerRows}`}>
                      ...
                      <a href = {`tel:${data.data.attributes.footerTel}`}>{data.data.attributes.footerTel}</a>

                      <Image src = {'/icons/wa_footer.png'} alt = "Иконка ватсап. В подвале" fill />
                    ...
                    <div className = {`${styles.footerRows}`}>
                      <a href = {`mailto:${data.data.attributes.callbackMail}`}>{data.data.attributes.callbackMail}</a>
                    </div>
                  </>
                  : <h3>Ошибка...Компонент: Footer</h3>
        }
