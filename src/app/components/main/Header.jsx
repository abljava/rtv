...
export const Header = ({}) => {
  ...
  switch(path) {
      case "/":
          return(
              <header key = {`key_mobile_${lang}`} className = {`${styles.headerContainer}`}>
                          ...
                          (mobile) ?
                              <Link href = "/">
                                  <div className = {`${styles.logoContainer}`}>
                                      ...
                                      <div className = {`${styles.imgContainer }`}>
                                          <Image unoptimized alt = "Логотип компании грузомир" src = "/logoSmall.svg" fill/>
                                      </div>
                                  </div>
