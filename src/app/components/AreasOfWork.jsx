        ...
        <div className={`${styles.downBlock}`}>
          {!data ? (
            ...
            data.data.map((item, index) => {
              return (
                <article
                  key={`areasKey_${index}_lang_${lang}`}
                ...
                >
                  <div className={`${styles.oneBlock}`}>
                    ...
                    <Link href={`/routes/services/${item.id}`}>
                      {index != 4 ? (
                        ...
                        >
                          <path
                            d="M19.3179 6.53033C19.6108 6.23744 19.6108 5.76256 19.3179 5.46967L14.5449 0.696699C14.252 0.403806 13.7771 0.403806 13.4842 0.696699C13.1914 0.989593 13.1914 1.46447 13.4842 1.75736L17.7269 6L13.4842 10.2426C13.1914 10.5355 13.1914 11.0104 13.4842 11.3033C13.7771 11.5962 14.252 11.5962 14.5449 11.3033L19.3179 6.53033ZM0 6.75H18.7875V5.25H0V6.75Z"
                            fill="white"
                          />
                        </svg>
                      ) : (
                  ...
                  <Image
                    src={"/downloads/services/bg_service.svg"}
    ...
    case "ru":
      return (
        <>
          ...
          <h2>
            Основные <strong>направления</strong>
          </h2>
        </>
      );
      break;
