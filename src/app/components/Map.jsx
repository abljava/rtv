...
const Map = ({langprop}) => {
    ...
    return(
        <section className = {`${styles.whybestContainer} ${main_styles.container} ${styles.mapContainer}`}>
...
const MapImage = ({x,y}) => {
    ...
    if(!mobile) return <Image src={'/map2.png'} alt={'Карта которая показывает регионы работы'} fill />
        ...
        <>
            {
                (scale == 1) ?
                    <Image onClick = {() => {
                        if(scale == maxScale)
                            ...
                            setScale(maxScale)
                    }} className={styles.lupa} src={'/icons/blueLupa.png'} alt={'Карта которая показывает регионы работы'} width={32} height={32} />
                    : null
            }


                <Image style = { (scale == maxScale) ? {
                ...
                src={'/map2.png'} alt={'Карта которая показывает регионы работы'} fill />
        </>
    )
        ...
        case 'en':
            return(
                <>
                    ...
                    <h2>Regional <strong>coverage</strong></h2>
                    <p>
                        The amount of pyroclastic material stops the transport. Differential zone<br />
                        subsidence, within the Mologo-Sheksninskaya, Nerlskaya and Meshcherskaya lowlands,<br />
        ...
        case 'zh':
            return(
                <>
                    ...
                    <h2>区域<strong>覆盖 </strong></h2>
                    <p>
                        火山碎屑物质的数量阻止了转移。 差异区 <br />
                        Mologo-Sheksninskaya、Nerlskaya 和 Meshcherskaya 低地内的沉降，<br />
                        相对较弱地削弱恶性斜铁矿
                    </p>
                </>
            )
