    ...
    case "header":
      return (
        <nav className={`${styles.nav}`}>
          {!isLoading && data && typeof data.data != "undefined"
            ? data.data.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {typeof item.attributes.childs.data != "undefined" &&
                      typeof item.attributes.childs.data[0] != "undefined" && (
                        <svg
                          viewBox="0 0 16 9"
                          fill="none"
            ...
            ? data && typeof data.data != "undefined"
              ? data.data.map((item, index) => {
                  if (
                    ...
                    return (
                      <div
                        key={`navmenu_footer_div${index}_${lang}`}
                      ...
                      >
                        ...
                        <div className={`${footerStyle.footerNavChilds}`}>
                          {typeof item.attributes.childs.data != "undefined" &&
                          typeof item.attributes.childs.data[0] !=
                            "undefined" ? (
                            <>
                              <DropMenuItems
                                showIndex={showHeaderDrop}
...
const DropMenuItems = ({
  ...
  return (
    <div
      className={`${styles.dropMenu2lvlContainer} ${
        index === showIndex ? styles.show : styles.hidden
      }`}
    >
